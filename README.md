...
> **Available in two languages** via a language selector landing page:
> - 🇳🇱 **Dutch** — `index-nl.html`
...
4. The landing page (`index.html`) lets users choose their language
...
├── index-nl.html    # Dutch version — application structure and wizard steps
