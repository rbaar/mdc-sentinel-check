...
const checklistData = {
    ...
    logbronnen: {
        "log-tier1": [
            ...
            { id: "log-t1-entra", title: "Microsoft Entra ID", desc: "Levert SigninLogs, AuditLogs, AADNonInteractiveUserSignInLogs, AADRiskyUsers en AADRiskyServicePrincipals. Gratis data connector (Entra ID P2 vereist).", type: "question", options: [{ value: "on", label: "Ja" }, { value: "off", label: "Nee" }, { value: "partial", label: "Weet ik niet" }, { value: "oos", label: "Buiten scope" }] },
            ...
            { id: "log-t1-secevt", title: "Windows Security Events", desc: "Levert SecurityEvent / WindowsEvent tabellen. Gepoolde 500 MB/dag x Defender for Servers P2-gelicentieerde servers via Defender for Servers P2 (alleen SecurityEvent-stream).", type: "question", options: [{ value: "on", label: "Ja" }, { value: "off", label: "Nee" }, { value: "partial", label: "Weet ik niet" }, { value: "oos", label: "Buiten scope" }] },
        ...
        "log-tier2": [
            ...
            { id: "log-t2-purview", title: "Microsoft Purview (Data Map / Discovery)", desc: "PurviewDataSensitivityLogs voor dataclassificatie, discovery en governance-zichtbaarheid.", type: "question", options: [{ value: "on", label: "Ja" }, { value: "off", label: "Nee" }, { value: "partial", label: "Weet ik niet" }, { value: "oos", label: "Buiten scope" }] },
            { id: "log-t2-purview-ip", title: "Microsoft Purview Information Protection (Preview)", desc: "MicrosoftPurviewInformationProtection voor label-, protectie- en information protection-events.", type: "question", options: [{ value: "on", label: "Ja" }, { value: "off", label: "Nee" }, { value: "partial", label: "Weet ik niet" }, { value: "oos", label: "Buiten scope" }] },
            { id: "log-t2-ti", title: "Threat Intelligence Platforms", desc: "ThreatIntelIndicators en ThreatIntelObjects voor IOC-verrijking. Gratis databron.", type: "question", options: [{ value: "on", label: "Ja" }, { value: "off", label: "Nee" }, { value: "partial", label: "Weet ik niet" }, { value: "oos", label: "Buiten scope" }] },
            { id: "log-t2-intune", title: "Microsoft Intune (Endpoint Management)", desc: "IntuneAuditLogs, IntuneOperationalLogs, IntuneDevices en IntuneDeviceComplianceOrg. Geen gratis ingestie.", type: "question", options: [{ value: "on", label: "Ja" }, { value: "off", label: "Nee" }, { value: "partial", label: "Weet ik niet" }, { value: "oos", label: "Buiten scope" }] },
            { id: "log-t2-3pid", title: "Third-Party Identity (Okta, CyberArk, Ping Identity, BeyondTrust)", desc: "Vendor-specifieke tabellen via API of CEF/Syslog. Conditioneel — alleen bij gebruik.", type: "question", options: [{ value: "on", label: "Ja" }, { value: "off", label: "Nee" }, { value: "partial", label: "Weet ik niet" }, { value: "oos", label: "Buiten scope" }] },
        ...
        "log-tier3": [
            ...
            { id: "log-t3-mcas", title: "Microsoft Defender for Cloud Apps (Standalone)", desc: "McasShadowItReporting voor shadow IT discovery.", type: "question", options: [{ value: "on", label: "Ja" }, { value: "off", label: "Nee" }, { value: "partial", label: "Weet ik niet" }, { value: "oos", label: "Buiten scope" }] },
            ...
            { id: "log-t3-github", title: "GitHub Enterprise", desc: "GitHubAuditLogsV2_CL voor source code en supply chain security.", type: "question", options: [{ value: "on", label: "Ja" }, { value: "off", label: "Nee" }, { value: "partial", label: "Weet ik niet" }, { value: "oos", label: "Buiten scope" }] },
            ...
            { id: "log-t3-storage", title: "Azure Storage Account", desc: "AzureMetrics, StorageBlobLogs, StorageQueueLogs, StorageTableLogs en StorageFileLogs voor platform- en data access-monitoring.", type: "question", options: [{ value: "on", label: "Ja" }, { value: "off", label: "Nee" }, { value: "partial", label: "Weet ik niet" }, { value: "oos", label: "Buiten scope" }] },
            { id: "log-t3-wef", title: "Windows Forwarded Events (Advanced)", desc: "WindowsEvent voor PowerShell, Sysmon en AppLocker.", type: "question", options: [{ value: "on", label: "Ja" }, { value: "off", label: "Nee" }, { value: "partial", label: "Weet ik niet" }, { value: "oos", label: "Buiten scope" }] },
