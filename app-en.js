...
const checklistData = {
    ...
    logbronnen: {
        "log-tier1": [
            ...
            { id: "log-t1-entra", title: "Microsoft Entra ID", desc: "Provides SigninLogs, AuditLogs, AADNonInteractiveUserSignInLogs, AADRiskyUsers and AADRiskyServicePrincipals. Free data connector (Entra ID P2 required).", type: "question", options: [{ value: "on", label: "Yes" }, { value: "off", label: "No" }, { value: "partial", label: "Don't know" }, { value: "oos", label: "Out of scope" }] },
            ...
            { id: "log-t1-secevt", title: "Windows Security Events", desc: "Provides SecurityEvent / WindowsEvent tables. Pooled 500 MB/day x Defender for Servers P2-licensed servers via Defender for Servers P2 (SecurityEvent stream only).", type: "question", options: [{ value: "on", label: "Yes" }, { value: "off", label: "No" }, { value: "partial", label: "Don't know" }, { value: "oos", label: "Out of scope" }] },
        ...
        "log-tier2": [
            ...
            { id: "log-t2-purview", title: "Microsoft Purview (Data Map / Discovery)", desc: "PurviewDataSensitivityLogs for data discovery and governance visibility.", type: "question", options: [{ value: "on", label: "Yes" }, { value: "off", label: "No" }, { value: "partial", label: "Don't know" }, { value: "oos", label: "Out of scope" }] },
            { id: "log-t2-purview-ip", title: "Microsoft Purview Information Protection (Preview)", desc: "MicrosoftPurviewInformationProtection for labeling, protection and information protection events.", type: "question", options: [{ value: "on", label: "Yes" }, { value: "off", label: "No" }, { value: "partial", label: "Don't know" }, { value: "oos", label: "Out of scope" }] },
            { id: "log-t2-ti", title: "Threat Intelligence Platforms", desc: "ThreatIntelIndicators and ThreatIntelObjects for IOC enrichment. Free data source.", type: "question", options: [{ value: "on", label: "Yes" }, { value: "off", label: "No" }, { value: "partial", label: "Don't know" }, { value: "oos", label: "Out of scope" }] },
            { id: "log-t2-intune", title: "Microsoft Intune (Endpoint Management)", desc: "IntuneAuditLogs, IntuneOperationalLogs, IntuneDevices and IntuneDeviceComplianceOrg. No free ingestion.", type: "question", options: [{ value: "on", label: "Yes" }, { value: "off", label: "No" }, { value: "partial", label: "Don't know" }, { value: "oos", label: "Out of scope" }] },
            { id: "log-t2-3pid", title: "Third-Party Identity (Okta, CyberArk, Ping Identity, BeyondTrust)", desc: "Vendor-specific tables via API or CEF/Syslog. Conditional — only when in use.", type: "question", options: [{ value: "on", label: "Yes" }, { value: "off", label: "No" }, { value: "partial", label: "Don't know" }, { value: "oos", label: "Out of scope" }] },
        ...
        "log-tier3": [
            ...
            { id: "log-t3-mcas", title: "Microsoft Defender for Cloud Apps (Standalone)", desc: "McasShadowItReporting for shadow IT discovery.", type: "question", options: [{ value: "on", label: "Yes" }, { value: "off", label: "No" }, { value: "partial", label: "Don't know" }, { value: "oos", label: "Out of scope" }] },
            ...
            { id: "log-t3-github", title: "GitHub Enterprise", desc: "GitHubAuditLogsV2_CL for source code and supply chain security.", type: "question", options: [{ value: "on", label: "Yes" }, { value: "off", label: "No" }, { value: "partial", label: "Don't know" }, { value: "oos", label: "Out of scope" }] },
            ...
            { id: "log-t3-storage", title: "Azure Storage Account", desc: "AzureMetrics, StorageBlobLogs, StorageQueueLogs, StorageTableLogs and StorageFileLogs for platform and data access monitoring.", type: "question", options: [{ value: "on", label: "Yes" }, { value: "off", label: "No" }, { value: "partial", label: "Don't know" }, { value: "oos", label: "Out of scope" }] },
            { id: "log-t3-wef", title: "Windows Forwarded Events (Advanced)", desc: "WindowsEvent for PowerShell, Sysmon and AppLocker.", type: "question", options: [{ value: "on", label: "Yes" }, { value: "off", label: "No" }, { value: "partial", label: "Don't know" }, { value: "oos", label: "Out of scope" }] },
